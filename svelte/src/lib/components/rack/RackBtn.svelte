...
<button
  ...
  style="{fill
    ...
    : hov
      ? 'var(--surface-hover)'
      : 'var(--surface-raised)'};border-style:solid;border-width:1px;border-color:{active
    ? `${color}33`
    ...
    : hov
      ? 'var(--ink-dim)'
      : 'var(--ink-faint)'};font-family:var(--font-ui);font-weight:500;font-size:9px;letter-spacing:0.04em;display:flex;align-items:center;justify-content:center;box-shadow:{active
