...
<div
  style="flex:5 1 0%;min-height:max(340px, 34vh);display:flex;align-items:center;justify-content:center;background:linear-gradient(180deg,#101214,#0c0d0f);border-bottom:2px solid #0d0e0f;padding:6px;min-width:0;container-type:size"
>
  {#if live}
    <div
