    ...
    <div class="rack-main">
      ...
      <div
        ...
        style="height:{$topRowCompact
          ? 'auto'
          : 'clamp(420px, calc((100vw - 186px) * 9 / 64 + 244px), 544px)'};flex-shrink:0;min-height:{$topRowCompact ? 'unset' : '300px'};transition:height 0.2s ease"
      >
      ...
      <div
        ...
        style="height:{$bottomRowCompact
          ? 'auto'
          : 'clamp(240px, calc((100vw - 186px) * 9 / 64 + 96px), 404px)'};flex-shrink:0;min-height:{$bottomRowCompact ? 'unset' : '176px'};border-top:2px solid #0d0e0f;transition:height 0.2s ease"
      >
